...
pub fn upper(val: &Value) -> Result<Value> {
    match val {
        ...
        _ => Err(Error::type_mismatch_msg("UPPER requires a string")),
    }
}
...
pub fn lower(val: &Value) -> Result<Value> {
    match val {
        ...
        Value::Null => Ok(Value::Null),
        _ => Err(Error::type_mismatch_msg("LOWER requires a string")),
    }
}
...
pub fn length(val: &Value) -> Result<Value> {
    match val {
        ...
        Value::Null => Ok(Value::Null),
        _ => Err(Error::type_mismatch_msg(
            "LENGTH requires a string or bytes",
        )),
    }
}
...
pub fn trim(val: &Value) -> Result<Value> {
    match val {
        ...
        Value::Null => Ok(Value::Null),
        _ => Err(Error::type_mismatch_msg("TRIM requires a string")),
    }
}
...
pub fn ltrim(val: &Value) -> Result<Value> {
    match val {
        ...
        Value::Null => Ok(Value::Null),
        _ => Err(Error::type_mismatch_msg("LTRIM requires a string")),
    }
}
...
pub fn rtrim(val: &Value) -> Result<Value> {
    match val {
        ...
        Value::Null => Ok(Value::Null),
        _ => Err(Error::type_mismatch_msg("RTRIM requires a string")),
    }
}
    ...
    match (val, start) {
        ...
        (Value::String(s), Value::Int64(start_idx)) => {
            ...
            let result = match len {
                ...
                _ => return Err(Error::type_mismatch_msg("SUBSTR length must be an integer")),
            };
...
pub fn replace(val: &Value, from: &Value, to: &Value) -> Result<Value> {
    match (val, from, to) {
        ...
        _ => Err(Error::type_mismatch_msg("REPLACE requires strings")),
    }
}
...
pub fn reverse(val: &Value) -> Result<Value> {
    match val {
        ...
        Value::Null => Ok(Value::Null),
        _ => Err(Error::type_mismatch_msg("REVERSE requires a string")),
    }
}
...
pub fn starts_with(val: &Value, prefix: &Value) -> Result<Value> {
    match (val, prefix) {
        ...
        _ => Err(Error::type_mismatch_msg("STARTS_WITH requires strings")),
    }
}
...
pub fn ends_with(val: &Value, suffix: &Value) -> Result<Value> {
    match (val, suffix) {
        ...
        _ => Err(Error::type_mismatch_msg("ENDS_WITH requires strings")),
    }
}
...
pub fn contains(val: &Value, substr: &Value) -> Result<Value> {
    match (val, substr) {
        ...
        _ => Err(Error::type_mismatch_msg("CONTAINS requires strings")),
    }
}
...
pub fn abs(val: &Value) -> Result<Value> {
    match val {
        ...
        Value::Null => Ok(Value::Null),
        _ => Err(Error::type_mismatch_msg("ABS requires a number")),
    }
}
...
pub fn round(val: &Value, precision: Option<&Value>) -> Result<Value> {
    let precision = match precision {
        ...
        None => 0,
        _ => {
            return Err(Error::type_mismatch_msg(
    ...
    match val {
        ...
        Value::Null => Ok(Value::Null),
        _ => Err(Error::type_mismatch_msg("ROUND requires a number")),
    }
}
...
pub fn floor(val: &Value) -> Result<Value> {
    match val {
        ...
        Value::Int64(n) => Ok(Value::Int64(*n)),
        Value::Null => Ok(Value::Null),
        _ => Err(Error::type_mismatch_msg("FLOOR requires a number")),
    }
}
...
pub fn ceil(val: &Value) -> Result<Value> {
    match val {
        ...
        Value::Int64(n) => Ok(Value::Int64(*n)),
        Value::Null => Ok(Value::Null),
        _ => Err(Error::type_mismatch_msg("CEIL requires a number")),
    }
}
...
pub fn sqrt(val: &Value) -> Result<Value> {
    match val {
        ...
        Value::Null => Ok(Value::Null),
        _ => Err(Error::type_mismatch_msg("SQRT requires a number")),
    }
}
...
pub fn cbrt(val: &Value) -> Result<Value> {
    match val {
        ...
        Value::Null => Ok(Value::Null),
        _ => Err(Error::type_mismatch_msg("CBRT requires a number")),
    }
}
...
pub fn power(base: &Value, exp: &Value) -> Result<Value> {
    match (base, exp) {
        ...
        _ => Err(Error::type_mismatch_msg("POWER requires numbers")),
    }
}
...
pub fn modulo(a: &Value, b: &Value) -> Result<Value> {
    match (a, b) {
        ...
        _ => Err(Error::type_mismatch_msg("MOD requires numbers")),
    }
}
...
pub fn sign(val: &Value) -> Result<Value> {
    match val {
        ...
        Value::Null => Ok(Value::Null),
        _ => Err(Error::type_mismatch_msg("SIGN requires a number")),
    }
}
...
pub fn exp(val: &Value) -> Result<Value> {
    match val {
        ...
        Value::Null => Ok(Value::Null),
        _ => Err(Error::type_mismatch_msg("EXP requires a number")),
    }
}
...
pub fn ln(val: &Value) -> Result<Value> {
    match val {
        ...
        Value::Null => Ok(Value::Null),
        _ => Err(Error::type_mismatch_msg("LN requires a number")),
    }
}
...
pub fn log(val: &Value, base: Option<&Value>) -> Result<Value> {
    let base = match base {
        ...
        _ => return Err(Error::type_mismatch_msg("LOG base must be a number")),
    };
    ...
    match val {
        ...
        Value::Null => Ok(Value::Null),
        _ => Err(Error::type_mismatch_msg("LOG requires a number")),
    }
}
...
pub fn log10(val: &Value) -> Result<Value> {
    match val {
        ...
        Value::Null => Ok(Value::Null),
        _ => Err(Error::type_mismatch_msg("LOG10 requires a number")),
    }
}
...
pub fn if_func(condition: &Value, then_val: &Value, else_val: &Value) -> Result<Value> {
    match condition {
        ...
        _ => Err(Error::type_mismatch_msg("IF condition must be a boolean")),
    }
}
