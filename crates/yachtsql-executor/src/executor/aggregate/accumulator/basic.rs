...
#[derive(Clone)]
pub(crate) struct CountAccumulator(pub(crate) i64);
...
#[derive(Clone)]
pub(crate) struct SumAccumulator(pub(crate) Option<f64>);
...
#[derive(Clone)]
pub(crate) struct MinAccumulator(pub(crate) Option<Value>);
...
#[derive(Clone)]
pub(crate) struct MaxAccumulator(pub(crate) Option<Value>);
...
#[derive(Clone)]
pub(crate) struct FirstAccumulator(pub(crate) Option<Value>);
...
impl FirstAccumulator {
    ...
    pub(crate) fn accumulate(&mut self, value: &Value) {
        if self.0.is_none() && !value.is_null() {
...
#[derive(Clone)]
pub(crate) struct LastAccumulator(pub(crate) Option<Value>);
